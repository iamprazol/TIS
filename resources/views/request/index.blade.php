                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($request->is_approved == 1)
                                            <a class="btn  btn-sm btn-primary" href="{{ route('information.edit', ['id' => $request->information_id]) }}">{{ __('Edit') }}</a>
                                        @else
                                            <button class="btn btn-sm btn-secondary">{{__('Request Sent')}}</button>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
