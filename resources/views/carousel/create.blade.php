                        ...
                        <form method="post" action="{{ route('carousel.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="title" id="title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('eg. district Name') }}" value="{{ old('title') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="tag" id="tag" class="form-control" placeholder="{{ __('Describe picture in short') }}" value="{{ old('tag') }}" required>
                                </div>
