                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('checkpoint.destroy', ['id' => $checkpoint->id]) }}" method="post">
                                            @csrf
                                            <button class="btn btn-sm btn-warning" type="button" class="dropdown-item" onclick="confirm('{{ __("Are you sure you want to delete this checkpoint?") }}') ? this.parentElement.submit() : ''">
                                                {{ __('Delete') }}
                                            </button>
                                        </form>
                                    </td>
