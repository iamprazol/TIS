...
@section('content')
    @include('users.partials.header', ['title' => __('Add Checkpoint')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('checkpoint.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <input name="checkpoint_name" id="checkpoint_name" class="form-control form-control-alternative{{ $errors->has('checkpoint_name') ? ' is-invalid' : '' }}" placeholder="{{ __('eg. Ramdi Bridge') }}" value="{{ old('checkpoint_name') }}" required>
