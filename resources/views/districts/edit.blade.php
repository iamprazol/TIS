            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('districts.update', ['id' => $district->id]) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('district_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="district_name" id="district_name" class="form-control form-control-alternative{{ $errors->has('district_name') ? ' is-invalid' : '' }}" placeholder="{{ __('District Name') }}" value="{{ old('district_name', $district->district_name) }}" required>
                                ...
                                <div class="form-group {{ $errors->has('picture') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            @if ("{{ asset('argon') }}/img/districts/{{ $district->picture }}")
                                                <img src="{{ asset('argon') }}/img/districts/{{ $district->picture }}"  style="height: 30vh;">
                                            @else
                                                <p>No image found</p>
                                            @endif
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{ $district->description }}</textarea>
                                </div>
